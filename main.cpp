...
const std::vector<std::string> AGENT_IDS = {"agent-1712327325" "agent-1713962163" "agent-1713954536" "agent-1713958591" "agent-1713958830" "agent-1713961903" "agent-1713967141"
};  // Dynamic vector from PluginIds
const std::string ENDPOINT_ID = "predefined-openai-gpt4.1";
const std::string REASONING_MODE = "medium";
